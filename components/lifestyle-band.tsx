...
// onto a void. No internal HeroReveal — SectionReveal in page.tsx owns the entrance,
// and a second layer of rise-on-h2 was contributing to the visual jump on slow loads.
